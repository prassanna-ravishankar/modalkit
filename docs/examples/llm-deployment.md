...
**For production queue setups, see:**
- [Queue Backend Patterns](queue-patterns.md) - Basic patterns and custom implementations
- [TaskIQ Integration](taskiq-integration.md) - Production-ready async processing
