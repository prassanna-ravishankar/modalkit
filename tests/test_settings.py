...
class TestCloudBucketMount:
    ...
    def test_cloud_bucket_mount_missing_required_fields(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            CloudBucketMount(  # type: ignore  # Intentionally missing bucket_name to test validation
        ...
        with pytest.raises(ValidationError) as exc_info:
            CloudBucketMount(  # type: ignore  # Intentionally missing mount_point to test validation
